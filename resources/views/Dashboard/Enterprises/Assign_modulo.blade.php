                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Asignar Modulos</li>
                        </ul>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="body">
                                <form action="{{ route('Dashboard.Enterprises.Assign_modules', $enterprise->id) }}" name="formularioassigr"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" id="resultquery">
                                            ...
                                            placeholder="Seleccione los modulos que desea asignarle a la empresa"
    ...
    <script>
        ...
        $("#algo").click(function() {
            ...
            if (module_add.length == 0) {
                Swal.fire({
                    title: 'Campo Vacio ',
                    text: 'Seleccione los modulos que desea asignarle a la empresa.',
                    type: 'warning'
                })
                $("#addmodules").focus();
                return false;
