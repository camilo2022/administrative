                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Asignar SubModulos</li>
                        </ul>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="body">
                                    <form method="POST" action="{{ route('Dashboard.Enterprises.Assign_submodules', $enterprise->id) }}" name="formularioreset">
                                        @csrf
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="form-group form-float" id="resultquery">
                                                    ...
                                                    placeholder="Seleccione los submodulos que desea asignarle al modulo de la empresa" id="sub_modules" name="sub_modules[]" multiple>
                                                    </select>
                                                </div>
                                        </div>
                                        <div class="col-md-12">
    ...
    <script>
        ...
        $("#getmodule").change(function() {
            ...
            $.ajax({
                ...
                url: "{{ route('Dashboard.Enterprises.Show.SubModule.allsubmodules') }}",
                type: "POST",
                ...
                success: function(response) {
                    ...
                    placeholder="Seleccione los submodulos que desea asignarle al modulo de la empresa" multiple>
                    `+options_add+`</select>`);
        ...
        $("#savemodulsubm").click(function(e) {
            ...
            if (data3.length == 0) {
                Swal.fire({
                    title: 'Campo Vacio ',
                    text: 'Seleccione los submodulos que desea asignarle al modulo de la empresa',
                    type: 'warning'
                })
                $("#sub_modules").focus();
                return false;
