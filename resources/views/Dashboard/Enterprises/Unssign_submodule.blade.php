                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Remover SubModulos</li>
                        </ul>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="body">
                                    <form method="POST" action="{{ route('Dashboard.Enterprises.Unssign_submodules', $enterprise->id) }}" name="formularioreset">
                                        @csrf
                                        <div class="col-md-12">
                                            <h5>Empresa: <b><label>{{ $enterprise->name_enterprise }}</label></b></h5>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <div class="form-group form-float" id="resultquery">
                                                    ...
                                                    placeholder="Seleccione los submodulos que desea removerle al modulo de la empresa" id="sub_modules" name="sub_modules[]" multiple>
                                                    </select>
                                                </div>
                                        </div>
                                        <div class="col-md-12">
                                            <a href="{{ route('Dashboard.Enterprises.Index') }}" class="btn btn-dark">Devolver</a>
...
@section('script')
    <script>
        ...
        $("#getmodule").change(function() {
            ...
            let identerprise = @json($enterprise->id);
            let data = {
                id: idmodule,
            ...
            $.ajax({
                ...
                url: "{{ route('Dashboard.Enterprises.Hide.SubModule.allsubmodules') }}",
                type: "POST",
                ...
                success: function(response) {
                    ...
                    placeholder="Seleccione los submodulos que desea removerle al modulo de la empresa" multiple>
                    `+options_add+`</select>`);
        ...
        $("#savemodulsubm").click(function(e) {
            ...
            if (data3.length == 0) {
                Swal.fire({
                    title: 'Campo Vacio ',
                    text: 'Seleccione los submodulos que desea removerle al modulo de la empresa',
                    type: 'warning'
                })
                $("#sub_modules").focus();
                return false;
            ...
            Swal.fire({
                title: '¿Desea removerle los submodulos?',
                type: 'warning',
