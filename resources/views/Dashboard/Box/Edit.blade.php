<!-- Modal Rol -->
<div class="modal" id="modal_caja_editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header w-100">
                <div class="card-header text-center w-100" style="background: white;">
                    <label style="font-size:20px;font-weight:bold;">Editar Caja de Compensacion</label>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="save_caja_e">Guardar</button>
            </div>
        </div>
    </div>
</div>
