                ...
                <div class="row">
                    <div class="col-lg-7 col-md-6 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Remover Modulos</li>
                        </ul>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="body">
                                <form action="{{ route('Dashboard.Enterprises.Unssign_modules', $enterprise->id) }}" name="formularioassigr"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group" id="resultquery">
                                            ...
                                            placeholder="Seleccione los modulos que desea removerle a la empresa"
                                            id="remmodules" name="remmodules[]" multiple>
                                                @foreach ($moduless as $modulo)
    ...
    <script>
        ...
        $("#algo").click(function() {
            ...
            if (module_rem.length == 0) {
                Swal.fire({
                    title: 'Campo Vacio ',
                    text: 'Seleccione los modulos que desea removerle a la empresa.',
                    type: 'warning'
                })
                $("#remmodules").focus();
                return false;
            ...
            Swal.fire({
                title: '¿Desea removerle los modulos?',
                type: 'warning',
